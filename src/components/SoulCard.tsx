...
export function SoulCard({ soul }: { soul: SoulEntity }) {
  ...
  return (
    <Link href={`/soul/${encodeURIComponent(soul.key)}`} className="block group">
      <div className="bg-surface/40 hover:bg-surface-hi/55 backdrop-blur-md [border-width:0.5px] border-white/[0.07] hover:border-white/[0.14] p-5 transition-colors duration-150 h-full flex flex-col">
        {/* Category row */}
